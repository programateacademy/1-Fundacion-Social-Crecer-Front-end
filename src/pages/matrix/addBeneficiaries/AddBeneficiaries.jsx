...
function AddBeneficiaries({ token }) {
  ...
  const addBeneficiary = async (e) => {
    ...
    try {
      console.log(token);
      await app
        .post('/api/admin/beneficiary', form, {
          headers: {
            Authorization: token,
          },
  ...
  const fetchApis = async (_) => {
    try {
      // Municipalities - Depending on the department name makes the query to the municipality belonging to that department
      // Beneficiary
  ...
  return (
    <>
      <button className='addUser' variant='primary' onClick={handleShow}>
              ...
              <TabPanel className='d-flex flex-wrap flex-gap'>
                <div>
                  ...
                  <input
                    ...
                    name='numDoc'
                    type='text'
                    value={form.numDoc} // This type of values brings the default data from the schema or stores it when it detects a data change using the onChange function.
                    required
                  />
                </div>
                <div>
                  ...
                  <select onChange={handleInput} name='curState'>
                    <option value={form.curState} hidden>
                      {form.curState}
                    </option>
                ...
                <div>
                  ...
                  <select onChange={handleInput} name='otherExitReason'>
                    <option value={form.otherExitReason} hidden>
                ...
                <div>
                  ...
                  <select onChange={handleInput} name='unityName' required>
                    ...
                    <option value='SEMBRANDO ESPERANZA'>
                      SEMBRANDO ESPERANZA
                    </option>
                    <option value='ESPACIOS CREATIVOS'>
                      ESPACIOS CREATIVOS
                    </option>
                    <option value='CRECER JUGANDO EN FAMILIA'>
                      CRECER JUGANDO EN FAMILIA
                    </option>
                    <option value='CRECIENDO CON AMOR EN FAMILIA'>
                      CRECIENDO CON AMOR EN FAMILIA
                    </option>
                    ...
                    <option value='SEMILLITAS DE AMOR'>
                      SEMILLITAS DE AMOR
                    </option>
                    <option value='SOÑADORAS'>SOÑADORAS</option>
                    <option value='GUERRERAS CONSTRUYE'>
                      GUERRERAS CONSTRUYE
                    </option>
                    <option value='TRIUNFADORAS'>TRIUNFADORAS</option>
                    <option value='GESTANDO FUTURO T3'>
                      GESTANDO FUTURO T3
                    </option>
                    <option value='GESTANDO FUTURO T2'>
                      GESTANDO FUTURO T2
                    </option>
                    <option value='GRAN BRITALIA T2'>GRAN BRITALIA T2</option>
                    <option value='ABRAHAM LINCOLN T3'>
                      ABRAHAM LINCOLN T3
                    </option>
                    ...
                    <option value='LORENZO ALCANTUZ I SECTOR'>
                    ...
                    <option value='M4 MUZUUN MUNDO MEJOR'>
                      M4 MUZUUN MUNDO MEJOR
                    </option>
                  </select>
                </div>
                <div>
                  ...
                  <select name='duoName' onChange={handleInput} required>
                    ...
                    <option value='U1-VINCULOS DE AMOR'>
                      U1-VINCULOS DE AMOR
                    </option>
                    <option value='U1-VINCULOS DE AMOR VEREDAS'>
                      U1-VINCULOS DE AMOR VEREDAS
                    </option>
                    <option value='U2-MIS ANGELITOS'>U2-MIS ANGELITOS</option>
                    <option value='U3-SEMILLAS DE PAZ'>
                      U3-SEMILLAS DE PAZ
                    </option>
                    <option value='U4-TEJIENDO SABERES'>
                      U4-TEJIENDO SABERES
                    </option>
                    <option value='U5-GRANDES TALENTOS'>
                      U5-GRANDES TALENTOS
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <select name='gender' onChange={handleInput}>
                    <option value={form.gender} hidden>
                      {form.gender}
                    </option>
                ...
                <div>
                  ...
                  <select name='disability' onChange={handleInput}>
                    <option value={form.disability} hidden>
                      {form.disability}
                    </option>
                ...
                <div>
                  ...
                  <select name='requiresAssistance' onChange={handleInput}>
                    <option value={form.requiresAssistance} hidden>
                      {form.requiresAssistance}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <select name='requiresTechSupport' onChange={handleInput}>
                    <option value={form.requiresTechSupport} hidden>
                      {form.requiresTechSupport}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <select name='hasTechSupport' onChange={handleInput}>
                    <option value={form.hasTechSupport} hidden>
                      {form.hasTechSupport}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                ...
                <div>
                  ...
                  <select name='requiresTherapy' onChange={handleInput}>
                    <option value={form.requiresTherapy} hidden>
                      {form.requiresTherapy}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <select name='countryOfResidence' onChange={handleInput}>
                    <option value={form.countryOfResidence} hidden>
                ...
                <div>
                  ...
                  <select name='residenceDepartment' onChange={handleInput}>
                    <option value={form.residenceDepartment} hidden>
                      {form.residenceDepartment}
                    </option>
                    <option value='BOGOTÁ, D.C.'>BOGOTÁ, D.C.</option>
                  </select>
                </div>
                <div>
                  ...
                  <select name='locationZone' onChange={handleInput}>
                    <option value={form.locationZone} hidden>
                      {form.locationZone}
                    </option>
                ...
                <div>
                  ...
                  <select name='headerType' onChange={handleInput}>
                    <option value={form.headerType} hidden>
                      {form.headerType}
                    </option>
                ...
                <div>
                  ...
                  <div>
                    <select name='neighborhood' onChange={handleInput}>
                      <option value={form.neighborhood} hidden>
                        {form.neighborhood}
                      </option>
                ...
                <div>
                  ...
                  <input
                    type='text'
                    name='foreignZoneName'
                    onChange={handleInput}
                    value={form.foreignZoneName}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select name='householdStratum' onChange={handleInputNum}>
                    <option value={form.householdStratum} hidden>
                      {form.householdStratum}
                    </option>
                ...
                <div>
                  ...
                  <select name='groupEthnicity' onChange={handleInput}>
                    <option value={form.groupEthnicity} hidden>
                      {form.groupEthnicity}
                    </option>
                    ...
                    <option value='RAIZAL DEL ARCHIPIELAGO DE SAN ANDRES, PROVIDENCIA Y SANTA CATALINA'>
                      {' '}
                ...
                <div>
                  ...
                  <select name='beneficiarySisbenized' onChange={handleInput}>
                    <option value={form.beneficiarySisbenized} hidden>
                      {form.beneficiarySisbenized}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <select
                    name='directlyAffectedByArmedConflict'
                    onChange={handleInput}
                  >
                    <option value={form.directlyAffectedByArmedConflict} hidden>
                      {form.directlyAffectedByArmedConflict}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div className='long-select'>
                  ...
                  <div>
                    ...
                    <select name='focusingCriteria' onChange={handleInput}>
                      <option value={form.focusingCriteria} hidden>
                        {form.focusingCriteria}
                      </option>
                ...
                <div>
                  ...
                  <select
                    name='justificationDocumentExists'
                    onChange={handleInput}
                  >
                    <option value={form.justificationDocumentExists} hidden>
                      {form.justificationDocumentExists}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
              ...
              <TabPanel className='d-flex flex-wrap flex-gap'>
                <div>
                  ...
                  <select name='guardianPersonType' onChange={handleInput}>
                    <option value={form.guardianPersonType} hidden>
                      {form.guardianPersonType}
                    </option>
                ...
                <div>
                  ...
                  <select name='guardianDocumentType' onChange={handleInput}>
                    <option value={form.guardianDocumentType} hidden>
                      {form.guardianDocumentType}
                    </option>
                    <option value='CC'>CC</option>
                    <option value='TI'>TI</option>
                    <option value='PEP'>PEP</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.guardianFirstLastname}
                    required
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.guardianSecondLastname}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select name='guardianBirthCountry' onChange={handleInput}>
                    <option value={form.guardianBirthCountry} hidden>
                      {form.guardianBirthCountry}
                    </option>
                    <option value='COLOMBIA'>COLOMBIA</option>
                    <option value='VENEZUELA'>VENEZUELA</option>
                    <option value='ECUADOR'>ECUADOR</option>
                ...
                <section className='bottom-tab-button'>
                  ...
                  <button
                    className='addUser'
                    onClick={(_) => handleButtonClick(0)}
                  >
                    Anterior
                  </button>
                  <button
                    className='addUser'
                    onClick={(_) => handleButtonClick(2)}
                  >
                    Siguiente
                  </button>
                </section>
              ...
              <TabPanel className='d-flex flex-wrap flex-gap'>
                <div>
                  ...
                  <select name='fatherDocumentType' onChange={handleInput}>
                    <option value={form.fatherDocumentType} hidden>
                      {form.fatherDocumentType}
                    </option>
                    <option value='CC'>CC</option>
                    <option value='TI'>TI</option>
                    <option value='PEP'>PEP</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.fatherDocumentNumber}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.fatherFirstLastname}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.fatherSecondLastname}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select name='fatherBirthCountry' onChange={handleInput}>
                    <option value={form.fatherBirthCountry} hidden>
                      {form.fatherBirthCountry}
                    </option>
                    <option value='COLOMBIA'>COLOMBIA</option>
                    <option value='VENEZUELA'>VENEZUELA</option>
                    <option value='ECUADOR'>ECUADOR</option>
              ...
              <TabPanel className='d-flex flex-wrap flex-gap'>
                <div>
                  ...
                  <select name='motherDocumentType' onChange={handleInput}>
                    <option value={form.motherDocumentType} hidden>
                      {form.motherDocumentType}
                    </option>
                    <option value='CC'>CC</option>
                    <option value='TI'>TI</option>
                    <option value='PEP'>PEP</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.motherDocumentNumber}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.motherFirstLastname}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='text'
                    value={form.motherSecondLastname}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select name='motherBirthCountry' onChange={handleInput}>
                    <option value={form.motherBirthCountry} hidden>
                      {form.motherBirthCountry}
                    </option>
                    <option value='COLOMBIA'>COLOMBIA</option>
                    <option value='VENEZUELA'>VENEZUELA</option>
                    <option value='ECUADOR'>ECUADOR</option>
              ...
              <TabPanel className='d-flex flex-wrap flex-gap'>
                <div>
                  ...
                  <select name='regime' onChange={handleInput} required>
                    <option value={form.regime} hidden>
                      {form.regime}
                    </option>
                    <option value='NO SE ENCUENTRA AFILIADO'>
                      NO SE ENCUENTRA AFILIADO
                    </option>
                ...
                <div>
                  ...
                  <select name='eps' onChange={handleInput} required>
                    ...
                    <option value='MALLAMAS EPS INDÍGENA'>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInput}
                    type='date'
                    value={form.vaccinationVerificationDate}
                  />
                </div>
                <div>
                  <label>
                  ...
                  <select name='vaccinationCardUpToDate' onChange={handleInput}>
                    <option value={form.vaccinationCardUpToDate} hidden>
                      {form.vaccinationCardUpToDate}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <select
                    name='hasGrowthAndDevelopmentCard'
                    onChange={handleInput}
                  >
                    <option value={form.hasGrowthAndDevelopmentCard} hidden>
                      {form.hasGrowthAndDevelopmentCard}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <input
                    name='growthDevelopmentControlsReceived'
                    onChange={handleInputNum}
                    type='number'
                    value={form.growthDevelopmentControlsReceived}
                  />
                </div>
                <div>
                  <label>ANTECEDENTE DE PREMATUREZ</label>
                  <select name='prematurenessBackground' onChange={handleInput}>
                    <option value={form.prematurenessBackground} hidden>
                      {form.prematurenessBackground}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <select name='under40Weeks' onChange={handleInput}>
                    <option value={form.under40Weeks} hidden>
                      {form.under40Weeks}
                    </option>
                ...
                <div>
                  ...
                  <input
                    ...
                    type='number'
                    step='any'
                    value={form.gestationalAgeAtBirth}
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select
                    name='exclusivelyBreastfeeding'
                    onChange={handleInput}
                  >
                    <option value={form.exclusivelyBreastfeeding} hidden>
                      {form.exclusivelyBreastfeeding}
                    </option>
                    <option value='NO'>NO</option>
                    <option value='SI'>SI</option>
                  </select>
                ...
                <div>
                  ...
                  <input
                    name='exclusiveBreastfeedingDuration'
                    onChange={handleInputNum}
                    type='number'
                    value={form.exclusiveBreastfeedingDuration}
                  />
                </div>
                <div>
                  <label>DURACIÓN LACTANCIA MATERNA TOTAL (MESES)</label>
                  <input
                    name='totalBreastfeedingDuration'
                    onChange={handleInputNum}
                    type='number'
                    value={form.totalBreastfeedingDuration}
                  />
                </div>
                <div>
